...
__BRYTHON__.compiled_date="2015-01-31 14:41:33.512000"
__BRYTHON__.builtin_module_names=["posix","__random","_ajax","_browser","_html","_io","_jsre","_multiprocessing","_os","_posixsubprocess","_svg","_sys","_time","_timer","builtins","dis","hashlib","javascript","json","long_int","math","modulefinder","_codecs","_collections","_csv","_dummy_thread","_functools","_imp","_io","_markupbase","_random","_socket","_sre","_string","_struct","_sysconfigdata","_testcapi","_thread","_warnings","_weakref"]
...
$B.leave_frame=function(){$B.frames_stack.pop()}})(__BRYTHON__)
...
for(var attr in obj){_b_.dict.$dict.__setitem__(res,attr,obj[attr])
}
return res
}
