...
if(!$B.$dict_contains($B.events,_id)){$B.$dict_set($B.events,_id,dict())
}
if(!$B.$dict_contains($B.$dict_getitem($B.events,_id),event)){$B.$dict_set($B.$dict_getitem($B.events,_id),event,[])
}
