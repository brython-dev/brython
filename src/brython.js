...
res.setItem=function(key,value){localStorage.setItem(key,value)
}
res.removeItem=function(key){localStorage.removeItem(key)
}
res.length=function(){return localStorage.length
}
res.key=function(item){return localStorage.key(item)
}
res.clear=function(){localStorage.clear()
}
return res
}
...
res.setItem=function(key,value){sessionStorage.setItem(key,value)
}
res.removeItem=function(key){sessionStorage.removeItem(key)
}
res.length=function(){return sessionStorage.length
}
res.key=function(item){return sessionStorage.key(item)
}
res.clear=function(){sessionStorage.clear()
}
return res
}
