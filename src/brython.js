...
$DictDict.get=function(self,key,_default){ret=$DictDict.__getitem__(self,key)
...
win.get_postMessage=function(msg,targetOrigin){if(isinstance(msg,dict)){msg=msg.$dict.copy()
}
