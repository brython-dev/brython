...
class TurtleScreenBase:
    ...
    def _drawpoly(self, polyitem, coordlist, fill=None,
        ...
        """
        #_coordlist=['%s,%s' % (_x*self.xscale, _y*self.yscale) for _x,_y in coordlist]
        #_poly = _svg.polygon(points=','.join(_coordlist), 
        #                     style={'fill': fill, 
        #                            'stroke': outline})
        #self._canvas <= _poly
        pass
    ...
    def _drawline(self, lineitem, coordlist=None,
        ...
        if coordlist is not None:
           ...
           if lineitem.isvisible():
              if lineitem in self._turtle_heading:
                 if self._turtle_heading[lineitem] != lineitem.heading():

                    _rotate=self._turtle_heading[lineitem]
                    ...
                    _turtle <= _svg.animateTransform(
                                                     ...
                                                     dur=_dur,
                                                     begin="animateLine%s.end" % (draw_count-1))

                    _turtle <= _svg.set(attributeName="display", attributeType="CSS",
                                        to="block",
                                        begin="animateLine%s.begin" % draw_count,
                                        end="animateLine%s.end" % draw_count)
           ...
           _an1=_svg.animate(Id="animateLine%s" % draw_count,
                             attributeName="x2", 
                             From=_x0*self.xscale, to=_x1*self.xscale,
                             dur=_dur, fill='freeze')

           _an2=_svg.animate(attributeName="y2", 
                             begin="animateLine%s.begin" % draw_count,
           ...
           if lineitem.isvisible():
              ...
              _turtle <= _svg.animateMotion(From="%s,%s" % (_x0*self.xscale, _y0*self.yscale),
                                        ...
                                        dur=_dur, begin="animateLine%s.begin" % draw_count)
           ...
           #console.log(self._turtles[0].heading())
           self._turtle_heading[lineitem]=lineitem.heading()

           if draw_count == 1:
              _an1.setAttribute('begin', "0s")
           else:
              _an1.setAttribute('begin', "animateLine%s.end" % (draw_count-1))
    ...
    def _delete(self, item):
        ...
        """
        #if item == 'all':
        #   self._ctx.clearRect(0,0,self.cv.width,self.cv.height)
        #self.cv.delete(item)
        pass
...
class RawTurtle(TPen, TNavigator):
    ...
    def rect_from_points(self, points):
        _width=self.screen._canvas.width
        _height=self.screen._canvas.height
        _min_x=_width
        _max_x=0
        _min_y=_height
        _max_y=0
...
##############################  stamp stuff  ###############################
    ...
    def _goto(self, end):
        ...
        if self._speed and screen._tracing == 1:
            ...
            top=False   #please remove me
            if self._drawing:
               screen._drawline(self,     #please remove me eventually
                                (start, end),
...
#for methodname in _tg_turtle_functions:
#for methodname in _turtle_functions.keys():
#    #pl1, pl2 = getmethparlist(eval('Turtle.' + methodname))
#    #pl1, pl2 = getmethparlist(eval('Turtle.' + methodname))
#    pl2=pl1=_turtle_functions[methodname]
#    #if pl1 == "":
#    #    print(">>>>>>", pl1, pl2)
#    #    continue
