...
class TestInheritance(unittest.TestCase):
    ...
    def test_multiple_inheritance_mapping(self):
        ...
        class M4(dict, collections.abc.Sequence, C):
            pass
        self.assertEqual(self.check_sequence_then_mapping(M1()), "seq")
        self.assertEqual(self.check_sequence_then_mapping(M2()), "seq")
        self.assertEqual(self.check_sequence_then_mapping(M3()), "seq")
        self.assertEqual(self.check_sequence_then_mapping(M4()), "seq")
    ...
    def test_multiple_inheritance_sequence(self):
        ...
        self.assertEqual(self.check_mapping_then_sequence(S1()), "map")
        self.assertEqual(self.check_mapping_then_sequence(S2()), "map")
        self.assertEqual(self.check_mapping_then_sequence(S3()), "map")
        self.assertEqual(self.check_mapping_then_sequence(S4()), "map")
...
class TestPatma(unittest.TestCase):
    ...
    def test_patma_246(self):
        ...
        alts = [
            ...
            dict(a=12, b=11, c=13, d=14, e=16, f=18, g=10, h=10, i=12), # XXX report
        ]
    ...
    def test_patma_247(self):
        ...
        alts = [
            ...
            dict(y=False, a=12, b=11, c=13, d=14, e=16, f=18, g=10, h=10, i=12) # XXX report
        ]
