...
class TestJointOps(tester.Tester):
...
class TestSet(TestJointOps, tester.Tester):
    thetype = set
    basetype = set
...
class TestFrozenSet(TestJointOps, tester.Tester):
    thetype = frozenset
    basetype = frozenset
...
class TestBasicOpsEmpty(TestBasicOps, tester.Tester):
    def setUp(self):
        self.case   = "empty set"
        self.values = []
...
class TestBasicOpsSingleton(TestBasicOps, tester.Tester):
    def setUp(self):
...
class TestBasicOpsTuple(TestBasicOps, tester.Tester):
    def setUp(self):
...
class TestBasicOpsTriple(TestBasicOps, tester.Tester):
    def setUp(self):
...
class TestBasicOpsString(TestBasicOps, tester.Tester):
    def setUp(self):
...
class TestBasicOpsBytes(TestBasicOps, tester.Tester):
    def setUp(self):
        self.case   = "string set"
...
class TestBasicOpsMixedStringBytes(TestBasicOps, tester.Tester):
    def setUp(self):
...
class TestExceptionPropagation(tester.Tester):
...
class TestSetOfSets(tester.Tester):
...
class TestBinaryOps(tester.Tester):
    def setUp(self):
        self.set = set((2, 4, 6))
...
class TestUpdateOps(tester.Tester):
    def setUp(self):
        self.set = set((2, 4, 6))
...
class TestMutate(tester.Tester):
    def setUp(self):
        self.values = ["a", "b", "c"]
        self.set = set(self.values)
...
class TestSubsetEqualEmpty(TestSubsets, tester.Tester):
    left  = set()
    right = set()
    name  = "both empty"
    cases = "==", "<=", ">="
...
class TestSubsetEqualNonEmpty(TestSubsets, tester.Tester):
    left  = set([1, 2])
    right = set([1, 2])
    name  = "equal pair"
    cases = "==", "<=", ">="
...
class TestSubsetEmptyNonEmpty(TestSubsets, tester.Tester):
    left  = set()
    right = set([1, 2])
...
class TestSubsetPartial(TestSubsets, tester.Tester):
    left  = set([1])
    right = set([1, 2])
...
class TestSubsetNonOverlap(TestSubsets, tester.Tester):
    left  = set([1])
    right = set([2])
...
class TestOnlySetsNumeric(TestOnlySetsInBinaryOps, tester.Tester):
    def setUp(self):
        self.set   = set((1, 2, 3))
        self.other = 19
...
class TestOnlySetsDict(TestOnlySetsInBinaryOps, tester.Tester):
    def setUp(self):
        self.set   = set((1, 2, 3))
        self.other = {1:2, 3:4}
...
class TestOnlySetsOperator(TestOnlySetsInBinaryOps, tester.Tester):
    def setUp(self):
        self.set   = set((1, 2, 3))
...
class TestOnlySetsTuple(TestOnlySetsInBinaryOps, tester.Tester):
    def setUp(self):
        self.set   = set((1, 2, 3))
        self.other = (2, 4, 6)
        self.otherIsIterable = True
...
class TestOnlySetsString(TestOnlySetsInBinaryOps, tester.Tester):
    def setUp(self):
        self.set   = set((1, 2, 3))
        self.other = 'abc'
        self.otherIsIterable = True
...
class TestOnlySetsGenerator(TestOnlySetsInBinaryOps, tester.Tester):
    def setUp(self):
        def gen():
...
class TestCopyingEmpty(TestCopying, tester.Tester):
    def setUp(self):
        self.set = set()

#------------------------------------------------------------------------------

class TestCopyingSingleton(TestCopying, tester.Tester):
    def setUp(self):
        self.set = set(["hello"])

#------------------------------------------------------------------------------

class TestCopyingTriple(TestCopying, tester.Tester):
    def setUp(self):
        self.set = set(["zero", 0, None])

#------------------------------------------------------------------------------

class TestCopyingTuple(TestCopying, tester.Tester):
    def setUp(self):
        self.set = set([(1, 2)])

#------------------------------------------------------------------------------

class TestCopyingNested(TestCopying, tester.Tester):
    def setUp(self):
        self.set = set([((1, 2), (3, 4))])

#==============================================================================

class TestIdentities(tester.Tester):
    def setUp(self):
...
class TestVariousIteratorArgs(tester.Tester):
...
class TestWeirdBugs(tester.Tester):
...
class TestGraphs(tester.Tester):
