...
$B.builtin_class_flags = {
    ...
    types: {
        545154: ['async_generator', 'method-wrapper', 'getset_descriptor', 'classmethod_descriptor', 'member_descriptor', 'frame', 'coroutine', 'generator'],
        547202: ['builtin_function_or_method'],
        545026: ['cell', 'traceback'],
        528642: ['code', 'ellipsis', 'NoneType', 'NotImplementedType'],
        678146: ['function'],
        545090: ['mappingproxy'],
