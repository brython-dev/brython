...
:root {
  --brython-menu-color: CadetBlue;
  --brython-menu-color-selected: SkyBlue;
  --brython-menu-submenu-background-color: #fff;
...
.brython-menu-navbar-item {
    ...
    background-color: var(--brython-menu-color);
    color: #fff;
...
.brython-menu-navbar-item:hover {
    background-color: var(--brython-menu-color-selected);
}
...
.brython-menu-submenu {
    font-family: var(--brython-menu-font-family);
    background-color: var(--brython-menu-submenu-background-color);
    position: absolute;
    border-style: solid;
    border-width: 1px;
...
class Menu:
    ...
    def add_item(self, name, menu=False, callback=None):
        if self.parent is None:
            # First level
            item = html.SPAN(name, Class="brython-menu-navbar-item")
            self.container <= item
            ...
            item <= html.TD(name, Class="brython-menu-submenu-item")
    ...
    def add_menu(self, name):
        ...
        # add an item
        item = self.add_item(name, menu=True)
