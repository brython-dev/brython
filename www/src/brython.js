...
if(_block_async_flag){var parent_block=this.parent,child=this.parent
while(parent_block && 
...
if(func_name!==undefined){return func_name+'=(function()'
}else{return this.tree[0].to_js()+'=(function()'
}}}
function $DelCtx(C){
this.type='del'
this.parent=C
