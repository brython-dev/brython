...
var method=$B.method=$B.make_class("method",function(func,cls){var f=function(){return func(cls,...arguments)}
f.__class__=method
f.$infos=func.$infos
return f}
)
