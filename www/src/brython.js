...
if(filename===undefined){console.log('filenam undef, src',src)}
var symtable=$B._PySymtable_Build(_ast,filename)
var js_obj=$B.js_from_root(_ast,symtable,filename)
js_from_ast='// ast generated by parser\n'+js_obj.js
root._ast=_ast
...
`    ${line.trim()}\n`}
if(filename !=='<string>'){
var start=err.offset,marks='    '+' '.repeat(start-indent),nb_marks=1
...
return factory}}},JSObject:$B.JSObj,JSON:{__class__:$B.make_class("JSON"),parse:function(){return $B.structuredclone2pyobj(
...
return name}
function compile_check(obj){var check_func=Object.getPrototypeOf(obj)._check
...
$B.ast.Assign.prototype.to_js=function(scopes){compile_check(this)
...
return js}
$B.ast.AsyncFor.prototype.to_js=function(scopes){compile_check(this)
...
js+=`return item\n})()`
return js}
$B.ast.Break.prototype.to_js=function(scopes){compile_check(this)
var js=''
for(var scope of scopes.slice().reverse()){if(scope.ast instanceof $B.ast.For){js+=`no_break_${scope.id} = false\n`
break}}
js+=`break`
return js}
$B.ast.Call.prototype.to_js=function(scopes){compile_check(this)
...
return '// unknown'}
$B.ast.Continue.prototype.to_js=function(scopes){compile_check(this)
return 'continue'}
$B.ast.Delete.prototype.to_js=function(scopes){compile_check(this)
var js=''
...
for(var i=0,len=this.keys.length;i < len;i++){if(this.keys[i]===_b_.None ||this.keys[i]===undefined){
has_packed=true
...
js+=`locals, true)\n`}
return js.trimRight()}
$B.ast.ImportFrom.prototype.to_js=function(scopes){compile_check(this)
...
$B.ast.ListComp.prototype.to_js=function(scopes){compile_check(this)
...
$B.ast.Try.prototype.to_js=function(scopes){compile_check(this)
...
$B.js_from_root=function(ast_root,symtable,filename,namespaces){if($B.compiler_check){}
var scopes=[]
