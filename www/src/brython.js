...
var _ast=root.ast(),symtable=$B._PySymtable_Build(_ast,'exec'),js_obj=$B.js_from_root(_ast,symtable,filename,{local_name,exec_locals,global_name,exec_globals}),js=js_obj.js}}catch(err){var lineno=err.args[1][1]
...
$B.ast.Expression.prototype.to_js=function(scopes){try{init_scopes.bind(this)('expression',scopes)}catch(err){console.log('error, expression',$B.ast_dump(this))
throw err}
