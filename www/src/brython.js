...
if(this.async){if(this.type=="generator1"){res=`return $B.async_generator.$factory(${name})`}else{res='return $B.make_async('+name1+')'}}
...
function jsobj2dict(x){var d=_b_.dict.$factory()
