...
with open(init_path, 'w', encoding='utf-8') as out:
    ...
    out.write('/* set ob_type to _b_.type */\n')
    out.write('for(let cls in _b_){\n')
    out.write('    _b_[cls].ob_type = _b_.type\n')
    out.write('    _b_[cls].dict = Object.create(null)\n')
    out.write('    _b_[cls].tp_mro = $B.make_mro(_b_[cls])\n')
    out.write('}\n')
