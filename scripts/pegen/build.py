...
from pegen.javascript_generator import JavascriptParserGenerator
...
def build_javascript_generator(
    grammar: Grammar,
    grammar_file: str,
    output_file: str,
    skip_actions: bool = False,
    ...
    with open(output_file, "w") as file:
        gen: ParserGenerator = JavascriptParserGenerator(grammar, file)  # TODO: skip_actions
        gen.generate(grammar_file)
    return gen
...
def build_javascript_parser_and_generator(
    grammar_file: str,
    output_file: str,
    verbose_tokenizer: bool = False,
    verbose_parser: bool = False,
    ...
    """
    grammar, parser, tokenizer = build_parser(grammar_file, verbose_tokenizer, verbose_parser)
    gen = build_javascript_generator(
        grammar,
        grammar_file,
        output_file,
        skip_actions=skip_actions,
